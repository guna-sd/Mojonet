# Not yet there... this is least priority compared to mem management and backend impl..
# will be working after the base implementations...
...
# struct SymNode(Stringable, Writable):
