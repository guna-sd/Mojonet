...
#         ) -> SIMD[dtype, nelts],
#     ](tensor1: TensorType[dtype], tensor2: TensorType[dtype]) -> TensorType[
#         dtype
#     ]:
...
#                     idx,
#                     func[dtype, nelts](
#                         tensor1.load[nelts](idx), tensor2.load[nelts](idx)
#                     ),
#                 )

#             vectorize[operation, Self.nelts](
#                 num_elements - (num_elements % Self.nelts)
#             )

#             for i in range(
#                 num_elements - (num_elements % Self.nelts), num_elements
#             ):
#                 result.store[nelts=1](
#                     i, func(tensor1.load[nelts=1](i), tensor2.load[nelts=1](i))
#                 )
#             return result

#         @parameter
#         fn vec_op[nelts: Int](i: Int):
#             var flat_index1 = get_broadcast_index(
#                 i, tensor1.shape, result_shape
#             )
#             var flat_index2 = get_broadcast_index(
#                 i, tensor2.shape, result_shape
#             )
...
#             SIMD[dtype, nelts], SIMD[dtype, nelts]
#         ) -> SIMD[dtype, nelts],
#     ](tensor1: TensorType[dtype], value: Scalar[dtype]) -> TensorType[dtype]:
...
#     @staticmethod
#     fn tensor_operation[
#         func: fn[dtype: DType, nelts: Int] (SIMD[dtype, nelts], Int) -> SIMD[
#             dtype, nelts
#         ],
#     ](tensor1: TensorType[dtype], value: Int) -> TensorType[dtype]:
...
#             dtype, nelts
#         ],
#     ](tensor1: TensorType[dtype],) -> TensorType[dtype]:
...
fn apply[
    ...
    func: fn[width: Int] (SIMD[dtype, width]) -> SIMD[dtype, width],
    ...
    alias pow_of_2 = width._bit_width() - 1
    ...
    for i in range(pow_of_2, -1, -1):
        ...
        for _ in range((length - processed) // width):
            ...
            p_curr.store(func(p_curr.load[width=width]()))
            processed += width