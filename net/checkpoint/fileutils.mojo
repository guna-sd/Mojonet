...
#         return String(ptr=buffer, length=ssize)
...
# @register_passable("trivial")
# struct Bytes(Sized, Stringable, Representable, Writable):
...
#     @always_inline("nodebug")
#     fn __init__(out self, bytes: UnsafePointer[UInt8]):
#         var data = StaticTuple[UInt8, NBytes]()
...
#     @always_inline("nodebug")
#     fn __init__(out self, owned bytes: List[UInt8]):
#         var data = StaticTuple[UInt8, NBytes]()
...
#     @always_inline("nodebug")
#     fn __getitem__(ref self, index: Int) -> UInt8:
...
#     var bits = (value.cast[type64[dtype]()]()).cast[DType.uint64]()
#     var data = Bytes()
...
#     return (bits.cast[type64[dtype]()]()).cast[dtype]()
